...
export const AddLoading = () => {
  ...
  cy.log("element exist:", exists)
  if(exists){
  cy.get('#color_list_0 .ant-select-item-option-content').first().click({force: true})
  cy.wait(500);
}
else{
  ...
  cy.wait(500);
  cy.get('#crane').should('exist').should('be.empty').click()
  cy.wait(500);
  checkRecordeExist().then((exists) => {
  cy.log("element exist:", exists)
  if(exists){
  ...
  cy.wait(500);
  cy.get('#barge_line').should('exist').should('be.empty').click({force: true})
  cy.wait(500);
  checkRecordeExist().then((exists) => {
    cy.log("element exist:", exists)
    if(exists){
    cy.get('#barge_line_list_0 .ant-select-item-option-content').first().click({force: true})
    cy.wait(500);
 }
 else{
    cy.log('Dropdown not found')
  ...
  cy.wait(500);
  cy.get('#surveyor').should('exist').should('be.empty').click()
  cy.wait(500);
  checkRecordeExist().then((exists) => {
    cy.log("element exist:", exists)
    if(exists){
...
//Customer
cy.get('#ant_design_form_customer').clear( {force: true} ).should('exist').click({force: true})
cy.wait(500);
checkSelection('ant_design_form_customer_list_1', true).then((exists)=>{
if(exists){   
...
cy.wait(500);
cy.get('#ant_design_form_agent').should('exist').click({force: true} )
cy.wait(500);
checkSelection('agent_list_1', true).then((exists)=>{
if(exists){
...
cy.wait(500);
checkSelection('customer_0_cargo_list_1', true).then((exists)=>{
if(exists){
 cy.get('#customers_0_cargo_list_1').eq(0).click({force: true})
cy.wait(500);
}
else{
cy.log('dropdown not found ')
...
cy.wait(500);
cy.get('#tonnage0').should('exist').type('1000')
cy.wait(500);
cy.get('#pieces0').should('exist').type('1000')
cy.wait(500);
cy.get('#cbm0').should('exist').type('787842375')
cy.wait(500);
...
cy.wait(500);
cy.get('#target_tph0').should('exist').type('3287534')
cy.wait(500);
cy.get('#po_number0').should('exist').type('47385435')
cy.wait(500);
cy.get('#customers_0_liner_term').should('exist').click()
cy.wait(500);
checkSelection('customer_0_liner_term_list_1', true).then((exists)=>{
if(exists){
cy.get('#customers_0_liner_term_list_1').eq(0).click({force: true})
cy.wait(500);
}
else{
cy.log('dropdown not found ')
...
//NOTSELETEC DROPDOENS IN NALL CASE OF NOTES   
                           ...
                           cy.wait(500);
                              ...
                              cy.get('#dynamic_form_complex_events_0_event').should('exist').click({force: true})
                                ...
                                cy.log("element exist:", exists)
                                  ...
                                  cy.get('#dynamic_form_complex_events_0_event_list_1 .ant-select-item-option-content', { timeout: 10000 }).first().click({force: true})
                                  cy.wait(500);
                             }
                             else{
                                  cy.log('Dropdown not found')
                             ...
                             cy.get('#cargo').should('exist').click({force: true})
                              ...
                              cy.get('#barge').should('exist').click()
                                ...
                                cy.log("element exist:", exists)
                                  ...
                                  cy.get('#barge_list_1 .ant-select-item-option-content', { timeout: 10000 }).first().click({force: true})
                                  cy.wait(500);
                             }
                             else{
                                  cy.log('Dropdown not found')
...
cy.get('#code_group').should('exist').should('be.empty').click()
      ...
      cy.wait(500);
      cy.get('#event').should('exist').should('be.empty').click()
        cy.wait(500);
        checkRecordeExist().then((exists) => {
        cy.log("element exist:", exists)
          if(exists){
     ...
     cy.get('#cargo').should('exist').should('be.empty').click()
        cy.wait(500);
        checkRecordeExist().then((exists) => {
        cy.log("element exist:", exists)
          if(exists){
      ...
      cy.get('#equip').should('exist').should('be.empty').click()
      cy.wait(500);
      checkRecordeExist().then((exists) => {
      cy.log("element exist:", exists)
        if(exists){
      ...
      cy.get('#barge').should('exist').should('be.empty').click()
        cy.wait(500);
        checkRecordeExist().then((exists) => {
        cy.log("element exist:", exists)
          if(exists){
          ...
          cy.document().then((doc) => {
            ...
            if (body) {
              cy.wrap(body).within(() => {
                ...
                cy.wait(500);
                cy.get('#time_from_1').should('exist').clear().type(currentDate)
                cy.wait(500);
                cy.get('#time_to_1').should('exist').clear().type(dateSixDaysLater)
                cy.wait(500);
                cy.get('#activity').should('exist').clear().type('unload crane ')
                cy.wait(500);
                cy.get('#description').should('exist').clear().type('Load  & unload crane of glass ')
                cy.wait(500);
               cy.get('#cancel_Crane_Working_Times').should('exist').should('have.text', 'Cancel')
                cy.wait(500);
